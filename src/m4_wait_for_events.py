...
def run_test_wait_for_sum_of_cubes():
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 3
    actual = wait_for_sum_of_cubes(16.1)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
    ...
    print('TEST STARTED!  Has it ended?')
    expected = 4
    actual = wait_for_sum_of_cubes(99.0)
    print('Expected:', expected)
    print('Actual:  ', actual)
    print('TEST ENDED!')
